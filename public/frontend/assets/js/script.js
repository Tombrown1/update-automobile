!(function(a) {
    ...
    if (t.length > 0) {
        ...
        e.scroll(function() {
            var a = e.scrollTop();
            e.width() > 991 && a > l.top + 4
                ? t.hasClass("has-fixed") || t.addClass("has-fixed")
                : t.hasClass("has-fixed") && t.removeClass("has-fixed");
        });
    }
    var i = a("#slider");
    ...
    o.length > 0 &&
        o.each(function() {
            a(this).parallaxie({ speed: 0.3, offset: 0 });
        });
    ...
    d.length > 0 &&
        e.on("load", function() {
            d.children().fadeOut(300),
                ...
                s.delay(100).css({ overflow: "visible" });
        });
    var f = a(".scroll-to");
    f.length > 0 &&
        f.on("click", function() {
    ...
    h.length > 0 &&
        h.each(function() {
            ...
            void 0 !== l &&
                "" !== l &&
                (s.hasClass("has-bg-image") || s.addClass("has-bg-image"),
                "" !== i &&
                    "dark" === i[0] &&
                    (s.hasClass("light") || s.addClass("light")),
                e
    ...
    if (u.length > 0) {
        if (!a().validate || !a().ajaxSubmit)
            return (
                console.log(
                    "quoteForm: jQuery Form or Form Validate not Defined."
                ),
                !0
            );
        if (u.length > 0) {
    ...
    y.length > 0 &&
        y.magnificPopup({ gallery: { enabled: !0 }, type: "image" });
    var C = a(".map-holder");
    if (C.length > 0) {
    ...
    var sw = c.split("/").pop();
    s.append(
        '<div id="color-switch" class="colorPanel cp-custom"><a class="cart" href="https://www.facebook.com/ABA-Sports-CLUB-1926-254802221528724/" target="_blank"><i class="fa fa-facebook fa-fw"></i></a><a class="home-solid" href="../' +
            sw +
            '"><i class="fa fa-linkedin fa-fw"></i></a><a id="cpToggle" href="https://twitter.com/abasportsclub" target="_blank"><i class="fa fa-cog fa-twitter fa-fw"></i></a><ul></ul></div>'
    );
